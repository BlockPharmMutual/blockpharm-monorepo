...
export function Navigation() {
  ...
  return (
    <Navbar variant="sticky" isBordered={isLightTheme ? true : false}>
      <Navbar.Brand>
      ...
      <Navbar.Content enableCursorHighlight hideIn="xs" variant="underline">
        ...
        <Navbar.Link href="#">Provide Liquidity</Navbar.Link>
        <Navbar.Link href="#">Claims</Navbar.Link>
        <Navbar.Link href="#">Metrics</Navbar.Link>
        <Navbar.Link href="#">Governance</Navbar.Link>
      </Navbar.Content>
